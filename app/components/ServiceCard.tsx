...
const ServiceCard = ({ title, description, link, bgImgSrc }: IServices) => {
  return (
    <div
      ...
      className="h-[337px] w-full rounded bg-contain bg-no-repeat md:h-[474px]"
    >
      <div className="relative z-10 flex h-full flex-col items-start justify-between p-7 font-rubik">
        <div className="w-full">
          <h1 className="text-xl font-semibold leading-relaxed text-white sm:text-2xl md:text-3xl lg:text-4xl xl:text-[50px]">
            {title}
          </h1>

          <p className="text-sm font-thin text-white md:text-base lg:text-[20px]">
            {description}
          </p>
        </div>
