    ...
    <footer className="bg-primary px-5 pt-14 pb-10 md:p-10 lg:p-14 text-white font-work_sans w-full">
      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-5 sm:gap-7 lg:gap-10 xl:gap-20 gap-y-10 w-full">
        <div className="w-full">
          ...
          <p className=" font-medium text-sm lg:text-base xl:text-lg text-white mt-7">
            Your health is your most valuable asset. At Lamb Medicals, we treat
            it as such.
          </p>

          <p className="font-medium text-sm md:text-base lg:text-lg mt-8">
            Socials
          </p>

          <div className="mt-3 flex justify-start items-center gap-4">
            <button className="hover:opacity-55 ease transition-all">
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
        ...
        {/* Company */}
        <div className="w-full text-sm md:text-base lg:text-lg pl-0 lg:pl-10 xl:pl-20 2xl:pl-28">
          <h2 className="font-semibold">Company</h2>

          <div className="w-full space-y-4 mt-6 flex flex-col">
        ...
        {/* Contact */}
        <div className="w-full text-sm md:text-base lg:text-lg pl-0 lg:pl-10 xl:pl-20">
